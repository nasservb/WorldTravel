...
'aspieprogress': 'js/vendors/aspieprogress',
'dropzone': 'js/vendors/dropzone.min',
'datepicker': 'js/vendors/persian-datepicker.min',
'lightslider': 'js/vendors/lightslider',
'flip': 'js/vendors/jquery.flip.min',
'vue': 'js/vendors/vue.min',
'axios': 'js/vendors/axios.min',
'leaflet': 'js/vendors/leaflet',
'tinymce': 'js/vendors/tinymce/tinymce.min',
'raty': 'js/vendors/jquery.raty',
'counter': 'js/vendors/jquery.counter',
'lazy': 'js/vendors/jquery.lazy.min',
'jcrop': 'js/vendors/jcrop',
}
});
window.tabler = {
colors: {
