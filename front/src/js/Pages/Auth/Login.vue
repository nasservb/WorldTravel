                                        ...
                                        <div class="card-body  px-5 py-2 ">
                                            <h3 class="text-center">Login with Email and Password</h3>
                                                ...
                                                <div>
                                                    <div class=" row">
                                                        ...
                                                        <div class="col-md-12">
                                                            <input id="email" type="text"
                                                                   class="form-control "
                                                                   name="email" value="nasser.niazymobsser@admin.com" required
                                                    ...
                                                    <div class=" row">
                                                        <label for="email"
                                                               class="col-12 col-form-label text-left">Password
...
export default {
    ...
    methods: {
        login(){
            ...
            axios.post(route('auth.login'), { email: email , password:password })
                .then(response => {
