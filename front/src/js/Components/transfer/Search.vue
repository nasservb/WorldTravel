        ...
        <tr>
            ...
            <td>
                <input type="datetime-local" id="start-time" 
                    ...
                    :max=" (new Date((new Date()).setDate((new Date()).getDate() + 30))).getDate() " 
                    class="input"  />
            </td>
        </tr>
        <tr>
...
export default {
    ...
    methods:{
        ...
        show(item){
            this.$router.push({name:'transfer.show', params:{id :item.id}});
        }
    },
    computed: {
        item: {
