...
<table class="table table-striped table-bordered">
    ...
    <tr>
        ...
        <td>
            ...
            <label v-if="!edit">{{ item.source }}</label>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td>
            ...
            <label v-if="!edit">{{ item.destination }}</label>
        </td>
    </tr>
    <tr>
        <td>{{ __('common.start_time') }}</td>
        <td>
            <input type="datetime-local" disabled class="input" :value="item.start_time" />
    ...
    <tr>
        ...
        <td>
            <input type="datetime-local" disabled class="input" :value="item.end_time" />

        </td>
    </tr>
    <tr>
        <td>{{ __('common.pickup_time') }}</td>
        <td>
            <input type="datetime-local" disabled class="input" :value="item.pickup_time" />
    ...
    <tr>
        <td>{{ __('common.seats_booked') }}</td>
        <td>
            <label>{{ item.seats_booked }}</label>
        </td>
    </tr>
</table>
</template>
